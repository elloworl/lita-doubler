...
describe Lita::Handlers::Doubler, lita_handler: true do
	...
	describe 'routing' do
		it { is_expected.to_route('Lita double 2')}
		it { is_expected.to_route('Lita double    22')}
		it { is_expected.to_route('Lita double 4')}
		it { is_expected.to_route('Lita double two')}
		it { is_expected.to_route('Lita double 1e4')}
	end
